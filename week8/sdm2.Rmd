...
- Background data establishes the environmental domain of the study, whilst
presence data should establish under which conditions a species is more likely
to be present than on average.

- A closely related but different concept, that of "pseudo-absences", is also
used for generating the non-presence class. In this case, researchers try to
guess where absences might occur they may sample the whole region except at presence locations, or they might sample at places unlikely to be suitable for the species.  
...
#To  speed  up  processing,  let's  restrict  the  predictions  to  a  more  restricted area (de ned by a rectangular extent):
...
#error distribution are specied with the 'family' argument. Examples are:
